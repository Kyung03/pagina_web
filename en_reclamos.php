        ...
        <div class="container">
            <div class="row align-items-stretch justify-content-between">
                <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                    <a class="navbar-brand" href="index.php">Supermarket Online</a>
    ...
    <main>
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 my-4 mx-auto text-center">
            ...
            <form action="registrar_reclamo.php" method="POST"> 
                    <center>
                    <h1 class="display-5 fw-bold">Register Claim</h1>
                    <label for="num_factura">Invoice number :</label>
                    <input type="text" id="num_factura" name="num_factura" value="">
                    <br><br>
                    <label for="descripcion">Description:</label>
                    <input type="text" id="descripcion" name="Descripcion" value="">
                    <br><br>
                    <label for="tip_reclamo">Type of Claim: </label>
                    ...
                    <button class="btn btn-primary btn-lg" type="submit" id="myBtn">Register</button>
                    </center>
            </form>
